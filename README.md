...
- `max_delay` → Maximum historical payment delay  
- `avg_bill_amt` → Average monthly bill amount  

These improved model performance and interpretability.
...
- Enabled better credit decision-making  
...
## 📂 Project Structure
<img width="897" height="496" alt="Dashboard" src="https://github.com/user-attachments/assets/bc50b3f0-e587-4708-a532-d5ce47f3aaa9" />
